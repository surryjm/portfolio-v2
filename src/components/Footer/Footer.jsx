  ...
  return (
    <footer id="contact">
      ...
      <ul className="footer-line">
        <li><a className="gradient-link" href="mailto:surryjm@gmail.com" target="_blank">
          <FontAwesomeIcon icon={faEnvelope} aria-hidden="true" className="footer-fontAwesome" />Email</a>
          </li>
        <li><a className="gradient-link" href="https://www.linkedin.com/in/surryjmowery/" target="_blank">
          <FontAwesomeIcon icon={faLinkedin} aria-hidden="true" className="footer-fontAwesome" />LinkedIn</a>
        </li>
        <li><a className="gradient-link" href="https://github.com/surryjm" target="_blank">
          <FontAwesomeIcon icon={faGithub} aria-hidden="true" className="footer-fontAwesome" />Github</a>
        </li>
        <li><a className="gradient-link" href="https://codepen.io/surry/pens/showcase" target="_blank">
